...
jQuery(function($) {
    ...
    switcherHtml.push( '<a id="cbx-switcher-btn" class="cbx-switcher-btn" href="#"><span class="fa fa-cog" aria-hidden="true"></span></a>' );
    ...
    $.fn.SwitcherLoader = function() {
        ...
        $( 'a.cbx-switcher-clr-btn').on( 'click', function (e) {
            ...
            styleLinker.attr( 'href', 'assets/css/style' + $this.data( 'color-name' ) + '.css?v=2' );
